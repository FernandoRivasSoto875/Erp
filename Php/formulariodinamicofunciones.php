...
// Wrapper para renderizar fieldsets fuera del layout principal
function generarFieldsetContenido($fsName, $fieldsets, $valores = [], $soloLectura = false) {
    if (!isset($fieldsets[$fsName])) return '';
    return fd_render_fieldset_fallback($fsName, $fieldsets[$fsName]);
}
// Puedes agregar aquí más funciones auxiliares según las necesidades del formulario dinámico.
